...
def pretty_print_pair(all_gp_rs, metric_name,max_prog=10, is_numbered=True):
...
if __name__ == '__main__':
    ...
    if len(all_randgp_r) != 0:
        pretty_print_pair(all_randgp_r, args.metric, max_prog=args.max_prog, is_numbered=args.is_numbered)
