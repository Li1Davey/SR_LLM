...
class Livermore2_Vars4_16(KnownEquation):
    ...
    def __init__(self):
        super().__init__(num_vars=4)
        x = self.x
        self.eq_expression = [('add', 'binary'), ('sqrt', 'unary'),

                              ('mul', 'binary'),
                              ('X_1', 'var'),
                              ('add', 'binary'),
                              ('mul', 'binary'), (-1, 'const'), ('X_1', 'var'),
                              ('mul', 'binary'), (-1, 'const'),
                              ('mul', 'binary'), ('n2', 'unary'), ('X_0', 'var'), ('exp', 'unary'), ('X_1', 'var'),

                              ('add', 'binary'),

                              ('mul', 'binary'),
                              ('X_2', 'var'),
                              ('add', 'binary'), ('mul', 'binary'), (-1, 'const'), ('X_3', 'var'), ('div', 'binary'), (1.81, 'const'),
                              ('X_2', 'var'),

                              ('mul', 'binary'), (-2.34, 'const'), ('div', 'binary'), ('X_3', 'var'), ('X_0', 'var')]
        self.sympy_eq = sympy.sqrt(x[1] * (-x[0] ** 2 * sympy.exp(x[1]) - x[1])) + \
                        x[2] * (-x[3] + 1.81 / x[2]) \
                        - 2.34 * x[3] / x[0]
...
class Livermore2_Vars4_18(KnownEquation):
    ...
    def __init__(self):
        super().__init__(num_vars=4)
        x = self.x
        self.eq_expression = [('add', 'binary'), ('X_0', 'var'), ('add', 'binary'),

                              ('mul', 'binary'), (2.96, 'const'),
                              ('n2', 'unary'), ('add', 'binary'), (0.94, 'const'), ('add', 'binary'), ('mul', 'binary'), (-0.36, 'const'),

                              ('sqrt', 'unary'), ('X_1', 'var'),
                              ('mul', 'binary'), ('X_1', 'var'), ('n2', 'unary'), ('X_2', 'var'),

                              ('add', 'binary'), ('log', 'unary'), ('add', 'binary'), ('X_1', 'var'), ('mul', 'binary'), (-1, 'const'),
                              ('X_0', 'var'), ('sin', 'unary'), ('add', 'binary'), ('X_2', 'var'),
                              ('add', 'binary'), ('mul', 'binary'), (2, 'const'), ('X_1', 'var'), ('mul', 'binary'), (-1, 'const'),
                              ('mul', 'binary'), ('X_3', 'var'), ('exp', 'unary'), ('X_0', 'var')]
...
class Livermore2_Vars5_4(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'n2', 'const', 'sin', 'cos']
...
class Livermore2_Vars5_10(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'log', 'sin', 'cos', 'const']
...
class Livermore2_Vars5_14(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'const', 'exp', 'sin', 'cos']
...
class Livermore2_Vars5_15(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'sqrt', 'n2', 'log', 'const', 'sin', 'cos', 'const']
...
class Livermore2_Vars5_18(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'sqrt', 'n2', 'const', 'const']
...
class Livermore2_Vars6_3(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'sqrt', 'n2', 'n4', 'const']
...
class Livermore2_Vars6_10(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'n2', 'pow', 'sin', 'cos', 'const']
...
class Livermore2_Vars6_20(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'pow', 'sin', 'cos', 'const']
...
class Livermore2_Vars6_23(KnownEquation):
    ...
    _function_set = ['add', 'sub', 'mul', 'div', 'sqrt', 'n2', 'log', 'exp', 'pow', 'const']
